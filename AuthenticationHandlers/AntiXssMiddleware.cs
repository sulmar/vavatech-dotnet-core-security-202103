...
namespace AuthenticationHandlers
{
    ...
    public class AntiXssMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            ICrossSiteScriptingValidation validation = CrossSiteScriptingValidationFactory.Create(context.Request.ContentType);

            
            if (validation.IsDangerous(context.Request.Body))
            {
    ...
    public interface ICrossSiteScriptingValidation
    {
        bool IsDangerous(Stream stream);
    }

    public class JsonCrossSiteScriptingValidation : ICrossSiteScriptingValidation
    {
        public bool IsDangerous(Stream stream)
        {
            throw new NotImplementedException();
        }
    }

    public class XmlCrossSiteScriptingValidation : ICrossSiteScriptingValidation
    {
        public bool IsDangerous(Stream stream)
        {
            throw new NotImplementedException();
    ...
    public class ImageCrossSiteScriptingValidation : ICrossSiteScriptingValidation
    {
        public bool IsDangerous(Stream stream)
        {
            throw new NotImplementedException();
    ...
    public class CrossSiteScriptingValidationFactory
    {
        public static ICrossSiteScriptingValidation Create(string contentType)
        {
            switch(contentType)
            {
                case "application/json": return new JsonCrossSiteScriptingValidation();
                case "application/xml": return new XmlCrossSiteScriptingValidation();

                default: throw new NotSupportedException(contentType);
            }
        }
    }
